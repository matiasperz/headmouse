...
switch(valores2[2]){
  ...
  if ( (vx_prec - 5) <= vx && vx <= vx_prec + 5 && (vy_prec - 5) <= vy && vy <= vy_prec + 5) { // Al verificar el puntero notamos que no se mueve mucho de su posiciÃ³n actual: (en este caso un cuadro de 10px)
    count++;
    if (valor_click == '1' && count == 25) { // el click  ocurrirÃ¡ despuÃ©s de 2 segundos en los que el puntero ha parado en el cuadro de 10px: 20ms de retraso por 100 veces es 2000ms = 2s
